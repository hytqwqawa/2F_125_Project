...
class ImpactTimeControlGuidance:
    def __init__(self):
        ...
        # [修改] 保证前15个字段顺序不变，紧接着写入pos_x, pos_y，再追加新的追踪字段
        self.csv_keys = [
        ...
        rospy.loginfo("Path + time-scaling baseline initialized | CSV enabled")
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            telemetry = {
                ...
                'pos_x': self.current_x,       # [修改] 新增写入 telemetry 字典
                'pos_y': self.current_y,       # [修改] 新增写入 telemetry 字典
